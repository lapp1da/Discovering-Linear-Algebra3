...
{
  "id": "sec-Linear-Comb-Data-4-1",
  "level": "2",
  "url": "sec11-section-name.html#sec-Linear-Comb-Data-4-1",
  "type": "Activity",
  "number": "1.1.1",
  "title": ".",
  "body": "   Consider the scenario given above for the orders by three companies for four different products.    Thinking of the four Products from Table 1.1.1 as each being a vector where the entries of the vector store the orders made for each of the three companies, express this information as a set of four vectors in .        If Product 1 is priced at $12, Product 2 is priced at $9, Product 3 is priced at $15, and Product 4 is priced at $7, using these prices for each of the four Products in the table as scalars, write a linear combination of the vectors from your set from part (a) that when added will give a vector in that represents the revenue generated from each company.        In general, we can think of the selling price for each of the four products as scalars . Give an expression for the revenue generated by the purchases for the three companies expressing them as a three-entry revenue vector (one entry for each company).       "
},
{
